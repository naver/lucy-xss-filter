...
public class ContentTypeCacheRepo {
	...
	private final HashMap<String, ContentType> sHardBitmapCache =
        new LinkedHashMap<String, ContentType>(HARD_CACHE_CAPACITY * 4 / 3 + 1, 0.75f, true) {
        @Override
    ...
    private final static ConcurrentHashMap<String, WeakReference<ContentType>> sSoftBitmapCache =
        new ConcurrentHashMap<String, WeakReference<ContentType>>(HARD_CACHE_CAPACITY / 2);
